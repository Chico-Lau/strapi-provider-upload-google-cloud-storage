  ...
  return {
    ...
    async uploadStream(file) {
      ...
      if (file.mime == 'image/jpeg' || file.mime == 'image/png') {
        ...
        // const watermarkImage = await sharp('./providers/strapi-provider-upload-gcs-watermark/src/img/' + config.watermarkImage).resize(watermarkImageWidth).toBuffer();
        ...
        file.stream = sharp(buffer).rotate(180);
      }
